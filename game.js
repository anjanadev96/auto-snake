...
class Game {
  ...
  activeDot(x, y) {
    // var snake = new Image();
    // snake.src = "https://media.istockphoto.com/vectors/snake-python-skin-texture-seamless-pattern-black-on-white-background-vector-id533841158"
    // var snake_pat = ctx.createPattern(snake, "repeat");
